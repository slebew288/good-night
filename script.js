...
function mulaiketik2() {
    ...
    if (aaa == kal2.length) { setInterval(berjatuhan, 800); setTimeout(munculbwh, 1000); setTimeout(tombol, 1100); }
}
...
async function menuju() {
    const nomor = "6285954149202"; // Nomor WhatsApp tujuan
    const pesanwhatsapp = encodeURIComponent("Hallo, makasih ya alvan🤣"); // Pesan yang akan dikirim
    window.location = `https://api.whatsapp.com/send?phone=${nomor}&text=${pesanwhatsapp}`;
}
